...
export class ClientTokensUsecase {
    ...
    async refreshTokens(id: string): Promise<Token> {
        ...
        // 액세스 토큰 생성 (기본 1일)
        const accessToken = this.tokensService.generateJwtToken(
            payload,
            `${JWT_CONSTANTS.DEFAULT_ACCESS_TOKEN_EXPIRES_DAYS}d`,
        );
