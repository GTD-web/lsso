...
let AdminTokensController = class AdminTokensController {
    ...
    async findBySystemId(systemId) {
        try {
            ...
            return api_response_dto_1.ApiResponseDto.error('TOKENS_FETCH_ERROR', '시스템별 토큰을 조회하는 중 오류가 발생했습니다.');
        }
    }
    async findByUserId(userId) {
        try {
            ...
            return api_response_dto_1.ApiResponseDto.error('TOKENS_FETCH_ERROR', '사용자별 토큰을 조회하는 중 오류가 발생했습니다.');
        }
    }
    async findOne(id) {
        try {
...
__decorate([
    (0, common_1.Get)('system/:systemId'),
    (0, swagger_1.ApiOperation)({ summary: '시스템별 토큰 조회' }),
    (0, swagger_1.ApiParam)({ name: 'systemId', description: '시스템 ID' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
    ...
    __metadata("design:returntype", Promise)
], AdminTokensController.prototype, "findBySystemId", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AdminTokensController.prototype, "findByUserId", null);
__decorate([
    (0, common_1.Get)(':id'),
